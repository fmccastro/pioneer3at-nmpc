...
{
int dummy;
/** Matrix of size: 61 x 3 (row major format)
 * 
 *  Matrix containing 61 differential variable vectors.
 */
real_t x[ 183 ];

/** Matrix of size: 60 x 2 (row major format)
 * 
 *  Matrix containing 60 control variable vectors.
 */
real_t u[ 120 ];

/** Matrix of size: 61 x 5 (row major format)
 * 
 *  Matrix containing 61 online data vectors.
 */
real_t od[ 305 ];

/** Column vector of size: 300
 * 
 *  Matrix containing 60 reference/measurement vectors of size 5 for first 60 nodes.
 */
real_t y[ 300 ];

/** Column vector of size: 3
 * 
 *  Reference/measurement vector for the 61. node.
 */
real_t yN[ 3 ];
...
/** Matrix of size: 2 x 15 (row major format) */
real_t rk_diffsTemp2[ 30 ];

/** Matrix of size: 3 x 2 (row major format) */
real_t rk_diffK[ 6 ];

/** Matrix of size: 3 x 5 (row major format) */
real_t rk_diffsNew2[ 15 ];
...
/** Matrix of size: 180 x 2 (row major format) */
real_t evGu[ 360 ];
...
/** Matrix of size: 180 x 5 (row major format) */
real_t Q2[ 900 ];
...
/** Matrix of size: 5490 x 2 (row major format) */
real_t E[ 10980 ];
 ...
 *
 *  \param strategy Shifting strategy: 1. Initialize node 61 with xEnd. 2. Initialize node 61 by forward simulation.
