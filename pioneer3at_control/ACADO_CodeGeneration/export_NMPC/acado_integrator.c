...
acadoWorkspace.rk_xxx[6] = rk_eta[21];
acadoWorkspace.rk_xxx[7] = rk_eta[22];
acadoWorkspace.rk_xxx[8] = rk_eta[23];
acadoWorkspace.rk_xxx[9] = rk_eta[24];
...
{
tmp_index1 = (run1 * 3) + (j);
acadoWorkspace.rk_A[tmp_index1 * 6] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 15) + (j * 5)];
acadoWorkspace.rk_A[tmp_index1 * 6 + 1] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 15) + (j * 5 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 6 + 2] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 15) + (j * 5 + 2)];
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 6) + (j)] -= 1.0000000000000000e+00;
acadoWorkspace.rk_A[tmp_index1 * 6 + 3] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 15) + (j * 5)];
acadoWorkspace.rk_A[tmp_index1 * 6 + 4] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 15) + (j * 5 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 6 + 5] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 15) + (j * 5 + 2)];
...
acadoWorkspace.rk_diffsNew2[(i * 5) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
for (i = 0; i < 3; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 5) + (run1 + 3)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
