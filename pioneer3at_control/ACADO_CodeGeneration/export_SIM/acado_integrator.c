...
acadoWorkspace.rk_diffsNew2[(i * 5) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.0000000000000000e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.0000000000000000e-02;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
for (i = 0; i < 3; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 5) + (run1 + 3)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.0000000000000000e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.0000000000000000e-02;
}
}
