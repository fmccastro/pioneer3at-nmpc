...
b = bagreader('/home/fmccastro/Tese_RoverNavigation/ROS_workspaces/wsPy3/src/pioneer3at_viz/bagfiles/gpOff_terramechanicsOff/pathTracking/truePose/change_N/subset_10.bag')
...
msgCmdVel = b.message_by_topic( topic = '/pioneer3at/cmd_vel' )
msgCurrentRef = b.message_by_topic( topic = '/pioneer3at/currentRef' )
msgCurrentSol = b.message_by_topic( topic = '/pioneer3at/currentSol' )
msgCycleTime = b.message_by_topic( topic = '/pioneer3at/cycleTime' )
msgOptTime = b.message_by_topic( topic = '/pioneer3at/optTime' )
